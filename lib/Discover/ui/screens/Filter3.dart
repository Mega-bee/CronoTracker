...
class Filter3Screen extends StatelessWidget {
  const Filter3Screen({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
          child: Padding(
            ...
            child: ListView.separated(
                ...
                itemCount: filterList3.length,
                shrinkWrap: true,
                separatorBuilder: (BuildContext context, int index) => const Divider(),
                itemBuilder: (BuildContext context, int index) {
                  return DiscoverFilterWidget(
                    discoverFilter: filterList3[index], widget: ResultScreen(),
                  );
                }),
          )),
    );
